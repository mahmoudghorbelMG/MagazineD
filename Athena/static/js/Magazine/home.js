...
(function($) {
 ...
 const ssMobileMenu = function() {
    ...
    // Add the sticky class on scroll and hide/show the navigation bar
    $(window).on('scroll', function() {
      const currentScroll = $(window).scrollTop();
      
      if (currentScroll > previousScroll) {
        // Scrolling down
        $('.s-header').removeClass('s-header--sticky').addClass('s-header--hide');
      } else {
        // Scrolling up
        $('.s-header').addClass('s-header--sticky').removeClass('s-header--hide');
      }
